...
from atelier_api.validators import validate_cobra_content


def test_validate_cobra_content_emits_bilingual_stats_for_whale_alias() -> None:
    source = "\n".join(
        [
...
def test_validate_cobra_content_keeps_bilingual_warnings_empty_for_safe_surface() -> None:
    source = "\n".join(
        [
            "entity whale_1 0 0 fauna",
            "  lex Melkowuvune",
