...
$apiCmd = "`$env:DATABASE_URL='sqlite:///$sqlitePath'; `$env:KERNEL_BASE_URL='http://${KernelHost}:${KernelPort}'; py -m uvicorn atelier_api.main:app --host $ApiHost --port $ApiPort --app-dir '$apiRepo'"
