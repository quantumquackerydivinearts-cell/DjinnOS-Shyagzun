    ...
    return Settings(
        ...
        cors_allowed_origins=_parse_origins(
            os.getenv(
                ...
                "http://127.0.0.1:5173,http://localhost:5173,capacitor://localhost,http://localhost,https://shop.quantumquackery.org,https://atelier.quantumquackery.com,https://quantumquackery.org",
            )
        ),
        ...
        public_website_url=os.getenv("PUBLIC_WEBSITE_URL", "https://quantumquackery.org").strip(),
        public_atelier_url=os.getenv("PUBLIC_ATELIER_URL", "https://atelier.quantumquackery.com").strip(),
